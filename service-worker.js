const CACHE='citylab-v7.0.0';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./data/events.json','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png'];
